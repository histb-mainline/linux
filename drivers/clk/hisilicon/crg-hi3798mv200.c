...
#define HI3798MV200_FIXED_12M			76
#define HI3798MV200_FIXED_48M			77
#define HI3798MV200_FIXED_60M			78
#define HI3798MV200_FIXED_166P5M		79
#define HI3798MV200_SDIO0_MUX			80
#define HI3798MV200_COMBPHY0_MUX		81
...
static const struct hisi_fixed_rate_clock hi3798mv200_fixed_rate_clks[] = {
	...
	{ HI3798MV200_FIXED_250M, "250m", NULL, 0, 250000000, },
};
...
static const struct hisi_gate_clock hi3798mv200_gate_clks[] = {
	...
	{ HISTB_MMC_SAP_DLL_MODE, "clk_mmc_sap_dll_mode", "mmc_sample",
	...
	/* ETH */
	{ HISTB_ETH_BUS_CLK, "clk_eth_bus", NULL,
		CLK_SET_RATE_PARENT, 0xd0, 0, 0, },
	{ HISTB_ETH_CLK, "clk_eth", "clk_eth_bus",
...
#define HI3798MV200_SYSCTRL_NR_CLKS 16
